<template>
  ...
  >
    <v-list nav>
      <v-list-item prepend-icon="mdi-update" title="Запісы" value="applications" to="/profile/applications"></v-list-item>
      <v-list-item prepend-icon="mdi-cog" title="Наладкі" value="settings" to="/profile/settings"></v-list-item>
    </v-list>
  </v-navigation-drawer>
  <v-main>
